	...
	<div class="license-section">
		...
		?>
				...
				<div class="Configuration_btn">
					...
					// Get the API response and decode the JSON data with error handling
					$response_data = @file_get_contents($api_url);
					$response = $response_data ? json_decode($response_data) : null;

					// Check if the latest version is greater than the current version
					if ($response && isset($response->version) && version_compare($response->version, WLSM_VERSION, ">")) {
						?>
