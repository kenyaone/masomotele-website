		...
		if ( $sms_exam_result_report_enable ) {
			...
			$student_exam_data = $wpdb->get_row(
				$wpdb->prepare(
					...
					c.label as class_label, se.label as section_label, s.label as school_name,
					ex.label as exam_name, ex.start_date as exam_date,
			...
			$sms_to = $student_exam_data->father_phone ? $student_exam_data->father_phone : ( $student_exam_data->mother_phone ? $student_exam_data->mother_phone : $student_exam_data->phone );
