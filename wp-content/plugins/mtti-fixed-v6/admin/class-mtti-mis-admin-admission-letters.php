...
class MTTI_MIS_Admin_Admission_Letters {
    ...
    private function display_admission_letter($student_id) {
        ...
        $excluded_courses = array('computer applications', 'computer essentials', 'application');
        ...
        foreach ($enrolled_courses as $ec) {
            ...
            // Check if this course requires admission fee
            ...
            foreach ($excluded_courses as $excluded) {
                if (strpos($course_name_lower, $excluded) !== false) {
                    $this_course_needs_fee = false;
                    break;
                }
            }

            if ($this_course_needs_fee) {
        ...
        <body>
            ...
            <div class="letter-container">
                ...
                foreach ($enrolled_courses as $ec) {
                    ...
                    if (strpos($cn, 'health') !== false || strpos($cn, 'nursing') !== false || strpos($cn, 'healthcare') !== false || strpos($cn, 'cna') !== false) {
                ...
                <div style="background: #fff8e1; border-left: 4px solid #f9a825; padding: 12px 15px; margin: 10px 0 20px 0; border-radius: 3px;">
                    <p style="margin: 0; font-size: 11pt;">&#127467;&#127479; <strong>FREE German Language Classes Included</strong></p>
                    <p style="margin: 6px 0 0 0; font-size: 10pt; color: #555;">As part of this programme, you will receive <strong>FREE German Language classes</strong> running concurrently throughout the course at no extra cost. This equips you with language skills for health care opportunities in German-speaking countries.</p>
                </div>
