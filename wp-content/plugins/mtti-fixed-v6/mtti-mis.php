...
function mtti_inject_analytics() {
    if (is_admin()) return;
    ?>
    <!-- Google Analytics GA4 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-8ZEH42CBVL"></script>
    <script>window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-8ZEH42CBVL');</script>
    <!-- Meta Pixel -->
    <script>!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window,document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init','893318556963600');fbq('track','PageView');</script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=893318556963600&ev=PageView&noscript=1"/></noscript>
    <?php
}

// Clean output buffers early to prevent "headers already sent" errors during login
add_action('init', function() {
    if (defined('WP_ADMIN') && !WP_ADMIN && (isset($_POST['log']) || isset($_POST['pwd']) || isset($_POST['mtti_portal_login']) || isset($_POST['mtti_lecturer_login_submit']))) {
...
function mtti_mis_output_admission_letter($student_id) {
    ...
    $logo_url = MTTI_MIS_PLUGIN_URL . 'assets/images/logo.jpeg';
    $total_tuition = 0; $requires_additional_fees = false;
    ...
    foreach ($enrolled_courses as $ec) {
        ...
        $this_course_needs_fee = true;
        foreach ($excluded_courses as $excluded) {
            if (strpos($course_name_lower, $excluded) !== false) { $this_course_needs_fee = false; break; }
        }
        if ($this_course_needs_fee) { $requires_additional_fees = true; }
    }
    ...
    <div class="letter-container">
        ...
        <div style="background:linear-gradient(135deg,#1b5e20 0%,#2e7d32 100%);border-radius:8px;padding:18px 20px;margin:15px 0 20px 0;text-align:center;box-shadow:0 3px 10px rgba(0,0,0,0.15);">
            <p style="margin:0;font-size:15pt;color:#fff;font-weight:bold;letter-spacing:1px;">&#127467;&#127479; BONUS: FREE GERMAN LANGUAGE CLASSES &#127467;&#127479;</p>
            <p style="margin:8px 0 0 0;font-size:10pt;color:#c8e6c9;">This programme includes <strong style="color:#fff;">FREE German Language classes</strong> running concurrently at no extra cost — preparing you for health care opportunities in German-speaking countries.</p>
        </div>
        <?php endif; ?>
