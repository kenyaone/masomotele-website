...
<?php wp_body_open(); ?>
    ...
    <section class="about" id="about">
        <div class="about-container">
            <h2 class="section-title">Why Choose MTTI for Technical Training Courses?</h2>
    ...
    <section class="courses" id="courses">
        <div class="courses-container">
            <h2 class="section-title">MTTI's Popular Computer Training Courses</h2>
            <p class="section-subtitle">Enroll in our range of practical, market-driven computer and technical courses designed for career success</p>
    ...
    <section class="testimonials" id="testimonials">
        <div class="testimonials-container">
            <h2 class="section-title">MTTI Computer Training - Student Success Stories</h2>
            <p class="section-subtitle">Real success stories and reviews from our MTTI training course graduates</p>
    ...
    <section class="contact" id="contact">
        <div class="contact-container">
            <h2 class="section-title">Enroll at MTTI - Contact Us Today</h2>
            <p class="section-subtitle">Visit us or reach out - we're here to help you enroll and start your computer training journey</p>
            ...
            <div class="footer-grid">
                <div class="footer-section">
                    ...
                    <div class="social-links">
                        <a href="https://facebook.com/profile.php?id=61582282297969" title="Facebook" target="_blank" rel="noopener noreferrer">📘</a>
                        <a href="https://instagram.com" title="Instagram" target="_blank" rel="noopener noreferrer">📷</a>
                        <a href="https://x.com" title="X" target="_blank" rel="noopener noreferrer">𝕏</a>
                        <a href="https://linkedin.com" title="LinkedIn" target="_blank" rel="noopener noreferrer">💼</a>
                        <a href="https://wa.me/254712464936" title="WhatsApp" target="_blank" rel="noopener noreferrer">💬</a>
                    </div>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <p>📞 +254 712 464 936</p>
                    <p>📧 <a href="mailto:info@masomotele.ac.ke">info@masomotele.ac.ke</a></p>
                    <p class="footer-tagline">"Start Learning, Start Earning"</p>
                </div>
            </div>
